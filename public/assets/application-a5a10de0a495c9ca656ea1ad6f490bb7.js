...
(function() {
  ...
  Base.setUp = function() {
    ...
    return $(document).on('click', '.icon-social', Base.openSocialLink);
  };

  Base.directToNavLink = function(event) {
    return window.location = $(event.target).children('a').attr('href');
  };

  Base.openSocialLink = function(event) {
    var name, regex;
    ...
    if (name === 'email-me') {
      ...
      return window.open(I18n.t('social_link.' + name));
    }
  };
...
(function() {
  ...
  Product.setUpProduct = function() {
    return $(document).on('click', '.new_product input[type="radio"]', Product.renderImageForm);
  };

  Product.renderImageForm = function(event) {
    var current_id, translate_id;
    ...
    if ($('.' + translate_id).is(":hidden")) {
      ...
      return $('.' + translate_id).removeClass('hidden');
    }
  };

  $(function() {
    return Product.setUpProduct();
  });

}).call(this);
(function() {
  window.Review = this.Review || {};

  Review.setUpReview = function() {
    return $(document).on('click', '.icon-lang', Review.redirectToOfficialSite);
  };

  Review.redirectToOfficialSite = function(event) {
    var regex, target;
    target = $(event.target).attr('class');
    regex = /^icon-lang\ (\w+)-*.*$/;
    return window.open(I18n.t('official.' + regex.exec(target)[1]));
  };

  $(function() {
    return Review.setUpReview();
  });
...
;(function(factory) {
  ...
  I18n.translations = {"en":{"date":{"formats":{"default":"%Y-%m-%d","short":"%b %d","long":"%B %d, %Y"},"day_names":["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"],"abbr_day_names":["Sun","Mon","Tue","Wed","Thu","Fri","Sat"],"month_names":[null,"January","February","March","April","May","June","July","August","September","October","November","December"],"abbr_month_names":[null,"Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"order":["year","month","day"]},"time":{"formats":{"default":"%a, %d %b %Y %H:%M:%S %z","short":"%d %b %H:%M","long":"%B %d, %Y %H:%M"},"am":"am","pm":"pm"},"support":{"array":{"words_connector":", ","two_words_connector":" and ","last_word_connector":", and "}},"number":{"format":{"separator":".","delimiter":",","precision":3,"significant":false,"strip_insignificant_zeros":false},"currency":{"format":{"format":"%u%n","unit":"$","separator":".","delimiter":",","precision":2,"significant":false,"strip_insignificant_zeros":false}},"percentage":{"format":{"delimiter":"","format":"%n%"}},"precision":{"format":{"delimiter":""}},"human":{"format":{"delimiter":"","precision":3,"significant":true,"strip_insignificant_zeros":true},"storage_units":{"format":"%n %u","units":{"byte":{"one":"Byte","other":"Bytes"},"kb":"KB","mb":"MB","gb":"GB","tb":"TB"}},"decimal_units":{"format":"%n %u","units":{"unit":"","thousand":"Thousand","million":"Million","billion":"Billion","trillion":"Trillion","quadrillion":"Quadrillion"}}}},"errors":{"format":"%{attribute} %{message}","messages":{"inclusion":"is not included in the list","exclusion":"is reserved","invalid":"is invalid","confirmation":"doesn't match %{attribute}","accepted":"must be accepted","empty":"can't be empty","blank":"can't be blank","present":"must be blank","too_long":"is too long (maximum is %{count} characters)","too_short":"is too short (minimum is %{count} characters)","wrong_length":"is the wrong length (should be %{count} characters)","not_a_number":"is not a number","not_an_integer":"must be an integer","greater_than":"must be greater than %{count}","greater_than_or_equal_to":"must be greater than or equal to %{count}","equal_to":"must be equal to %{count}","less_than":"must be less than %{count}","less_than_or_equal_to":"must be less than or equal to %{count}","other_than":"must be other than %{count}","odd":"must be odd","even":"must be even","taken":"has already been taken","in_between":"must be in between %{min} and %{max}","spoofed_media_type":"has an extension that does not match its contents"}},"activerecord":{"errors":{"messages":{"record_invalid":"Validation failed: %{errors}","restrict_dependent_destroy":{"one":"Cannot delete record because a dependent %{record} exists","many":"Cannot delete record because dependent %{record} exist"}}}},"datetime":{"distance_in_words":{"half_a_minute":"half a minute","less_than_x_seconds":{"one":"less than 1 second","other":"less than %{count} seconds"},"x_seconds":{"one":"1 second","other":"%{count} seconds"},"less_than_x_minutes":{"one":"less than a minute","other":"less than %{count} minutes"},"x_minutes":{"one":"1 minute","other":"%{count} minutes"},"about_x_hours":{"one":"about 1 hour","other":"about %{count} hours"},"x_days":{"one":"1 day","other":"%{count} days"},"about_x_months":{"one":"about 1 month","other":"about %{count} months"},"x_months":{"one":"1 month","other":"%{count} months"},"about_x_years":{"one":"about 1 year","other":"about %{count} years"},"over_x_years":{"one":"over 1 year","other":"over %{count} years"},"almost_x_years":{"one":"almost 1 year","other":"almost %{count} years"}},"prompts":{"year":"Year","month":"Month","day":"Day","hour":"Hour","minute":"Minute","second":"Seconds"}},"helpers":{"select":{"prompt":"Please select"},"submit":{"create":"Create %{model}","update":"Update %{model}","submit":"Save %{model}"}},"hello":"Hello world","paperclip":{"default_url":"rails.png","url":"paperclip/products/:id/:style/:basename.:extension"},"official":{"ruby":"https://www.ruby-lang.org/en/","rails":"http://rubyonrails.org/","html5":"http://www.w3.org/TR/html5/","css3":"http://www.w3.org/Style/CSS/Overview.en.html","js":"https://developer.mozilla.org/en-US/docs/Web/JavaScript","python":"https://www.python.org/","coffeescript":"http://coffeescript.org/","mysql":"http://www.mysql.com/","postgresql":"http://www.postgresql.org/","scala":"http://www.scala-lang.org/","php":"http://php.net/","java":"http://docs.oracle.com/javase","android":"http://developer.android.com/"},"social_link":{"amazon":"http://www.amazon.com/gp/registry/wishlist/2M8XDGA4LZ3MQ","google":"https://plus.google.com/+DucPhanCanCode","youtube":"https://www.youtube.com/channel/UC_LaJzzryuuYNjyLIs0yS5Q/playlists","instagram":"http://instagram.com/phanducsjsu/","facebook":"https://www.facebook.com/TrongDucPhan","github":"https://github.com/PhDuc","email":"phanducsjsu@gmail.com","linkedin":"https://www.linkedin.com/in/iamduc"},"review":{"url":{"eb1571":{"name":"Eager loading association","link":"http://goo.gl/dLBWK"},"551db8":{"name":"Strong parameters","link":"http://goo.gl/wKIE8M"},"d7b1d6":{"name":"Bootstrap","link":"http://goo.gl/hU1AVD"},"bd8dd9":{"name":"Configurations change when upgrading Rails 3 to 4","link":"http://goo.gl/pSUOv"},"70617a":{"name":"Handle file upload","link":"http://goo.gl/6c6O"},"2d38ef":{"name":"Faster live reload sass","link":"http://goo.gl/wJYpA"},"b0a67e":{"name":"Change CSS with jQuery","link":"http://goo.gl/YqJ8xX"}}}},"de":{"errors":{"messages":{"in_between":"muss zwischen %{min} und %{max} sein","spoofed_media_type":"trägt eine Dateiendung, die nicht mit dem Inhalt der Datei übereinstimmt"}},"number":{"human":{"storage_units":{"format":"%n %u","units":{"byte":{"one":"Byte","other":"Bytes"},"kb":"KB","mb":"MB","gb":"GB","tb":"TB"}}}}},"es":{"errors":{"messages":{"in_between":"debe estar entre %{min} y %{max}","spoofed_media_type":"tiene una extensión que no coincide con su contenido"}},"number":{"human":{"storage_units":{"format":"%n %u","units":{"byte":{"one":"Byte","other":"Bytes"},"kb":"KB","mb":"MB","gb":"GB","tb":"TB"}}}}},"ja":{"errors":{"messages":{"in_between":"の容量は%{min}以上%{max}以下にしてください。","spoofed_media_type":"の拡張子と内容が一致していません。"}},"number":{"human":{"storage_units":{"format":"%n %u","units":{"byte":{"one":"Byte","other":"Bytes"},"kb":"KB","mb":"MB","gb":"GB","tb":"TB"}}}}},"pt-BR":{"errors":{"messages":{"in_between":"deve ter entre %{min} e %{max}","spoofed_media_type":"tem uma extensão que não corresponde ao seu conteúdo"}},"number":{"human":{"storage_units":{"format":"%n %u","units":{"byte":{"one":"Byte","other":"Bytes"},"kb":"KB","mb":"MB","gb":"GB","tb":"TB"}}}}},"zh-CN":{"errors":{"messages":{"in_between":"文件大小必须介于 %{min} 到 %{max} 之间","spoofed_media_type":"扩展名与内容类型不符"}},"number":{"human":{"storage_units":{"format":"%n %u","units":{"byte":{"one":"Byte","other":"Bytes"},"kb":"KB","mb":"MB","gb":"GB","tb":"TB"}}}}},"zh-HK":{"errors":{"messages":{"in_between":"必須介於%{min}到%{max}之間","spoofed_media_type":"副檔名與內容類型不匹配"}},"number":{"human":{"storage_units":{"format":"%n %u","units":{"byte":{"one":"Byte","other":"Bytes"},"kb":"KB","mb":"MB","gb":"GB","tb":"TB"}}}}},"zh-TW":{"errors":{"messages":{"in_between":"檔案大小必須介於 %{min} 到 %{max} 之間","spoofed_media_type":"副檔名與內容類型不符"}},"number":{"human":{"storage_units":{"format":"%n %u","units":{"byte":{"one":"Byte","other":"Bytes"},"kb":"KB","mb":"MB","gb":"GB","tb":"TB"}}}}}};
}));
